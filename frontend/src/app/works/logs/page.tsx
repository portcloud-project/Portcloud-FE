        ...
        <main className="w-full px-[24px] flex flex-col justify-start items-start mx-auto laptop:max-w-[1440px] tablet:w-full gap-[48px]">
            ...
            {searchTitle && (
                <div className="w-full flex flex-col gap-[16px]">
                    ...
                    <RecentLogs title={''} contentWithItem={filteredItems} />
                </div>
            )}
            {!isLoading && filteredItems.length === 0 && (
                <div className="flex flex-col justify-center items-center absolute top-[40vh] left-[50%] -translate-x-1/2 gap-[24px]">
                    <div className="text-[40px] font-bold">아직 기록이 등록되지 않았어요!</div>
