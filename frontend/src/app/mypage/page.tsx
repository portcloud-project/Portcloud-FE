                ...
                <TabsList>
                    <div className='flex flex-col justify-center items-center gap-[24px] w-full h-[344px] py-[48px] border-b-[1px] border-[var(--color-gray-300)]'>
                        ...
                        <div className='flex flex-col justify-center items-center gap-[4px]'>
                            ...
                            <h3 className='text-[var(--color-gray-500)] font-semibold text-[16px]'>이메일</h3>
                        </div>
                        <TabsTrigger value="profile" className="w-[121px] h-[40px] flex justify-center items-center text-[16px] font-semibold text-white bg-[var(--color-purple-500)] rounded-[20px]">
                            프로필 수정
                        </TabsTrigger>
                    </div>
