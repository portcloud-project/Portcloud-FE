                    ...
                    data?.map((item) => {
                        return (
                            <li
                                ...
                                key={`${item.id}`}
                                className="group min-w-[220px] w-full max-w-[330px] aspect-[4/3] min-h-[100px] perspective-[1000px] cursor-pointer tablet:shrink-0 tablet:w-full"
                            >
                                {/* 앞면 */}
